    ...
    <form action="/doIndex2" method="post">
        <table border="1px black solid;" style="width:500px;" class="table">
            ...
            <tr>
                ...
                <td><input type="text" name="assetsid" class="name"><span style="color: red">*</span></td>
            </tr>
            <tr>
                <td align="center">资产名称：</td>
                <td><input type="text" class="age" name="assetsname"><span style="color: red">*</span></td>
            </tr>
            <tr>
                <td align="center">资产类型：</td>
                <td><select class="rank" name="assetstype">
